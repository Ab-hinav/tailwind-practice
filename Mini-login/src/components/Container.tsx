      ...
      <Card className=" m-10  shadow-2xl ">
        <div className="flex ">
          <div className=" p-8 h-full w-full md:w-1/2 md:h-1/2 md:p-14">
            <CardHeader>
              <CardTitle className="text-4xl font-extrabold mb-4">
                Login{" "}
              </CardTitle>
              <CardDescription className="mt-2">
                Login to your account to upload download images
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="mt-8">
              ...
              <div className="mt-8 flex justify-between items-center md:flex-row flex-col space-y-2 ">
                <a className="cursor-pointer  text-xs md:text-sm">
                  Forgot Password?
                </a>
            ...
            <CardFooter className="mt-8  flex-col ">
              ...
              <div className="flex mt-8 w-full md:flex-row flex-col space-y-2 md:space-y-0 md:space-x-4 ">
                <Button
                  className="h-full w-full flex justify-evenly "
                  variant="outline"
                >
                  {" "}
                  <img
                ...
                >
                  {" "}
                  <img src={googl} className="w-6 h-6 md:w-12 md:h-12" /> Google
                </Button>
              </div>
            </CardFooter>
          </div>
          <div className="hidden md:block md:w-1/2 md:h-1/2">
            <img src={img1} className="w-[50rem] h-[40rem] md:h-[42rem]" />
          </div>
        </div>
      </Card>
    </div>
